...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            for (int i = 0; i < weatherArray.length(); i++) {
                ...
                //get today's weather for the wearable
                if (i == 0) {
    ...
    private void sendWeatherToWearable(double high, double low, int weather_id) {
        Log.d(LOG_TAG, "Sending weather info to wearable");
        ...
        /*
        * tutorial: https://developer.android.com/training/wearables/data-layer/data-items.html
        * */
        ...
        Wearable.DataApi.putDataItem(mGoogleApiClient, request).setResultCallback(new ResultCallback<DataApi.DataItemResult>() {
            ...
            public void onResult(@NonNull DataApi.DataItemResult dataItemResult) {
                if (!dataItemResult.getStatus().isSuccess()) {
                    Log.d(LOG_TAG, "Failed sending weather data to wearable");
                } else {
